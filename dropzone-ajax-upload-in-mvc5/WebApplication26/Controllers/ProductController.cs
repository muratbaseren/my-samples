...
namespace WebApplication26.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult UploadProductImages(int id, HttpPostedFileBase[] productpictures)
        {
            ...
            string uploadFullPath = Server.MapPath(uploadPathVirtual);

            if(Directory.Exists(uploadFullPath) == false)
            {
            ...
            foreach (var pp in productpictures)
            {
                ...
                string filename = $"f-{id}_{productPicture.Id}.{ext}";      // f-1-_1dfe2-sas45.png
                string fullFilePath = uploadFullPath + "/" + filename;      // C:/wwwroot/abc/uploads/f-1-_1dfe2-sas45.png
